...
# ref: https://github.com/mopp/sky-color-clock.vim/blob/master/autoload/sky_color_clock.vim
...
class SkyColorClockSegment(Segment):
    def __call__(self, pl, segment_info, hogehoge=True, fugafuga=False, format='%d %H:%M', istime=False):
